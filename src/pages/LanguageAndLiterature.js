...
import thinkImg from '../assets/create.png';   // If using /public, use src="/think.png" in the <img>
...
export default function InnovationAndCreation() {
  ...
  return (
    <div style={{ width: '100%', background: 'transparent' }}>
      <style>{`
       ...
       border-radius: 15px;
          ...
          user-select: none;
            ...
            .chip:hover { background: #bdf3e5ff; transform: translateY(-1px); }
      ...
      <header className="hero full-bleed" aria-label="Innovation & Creation">
        <img src={thinkImg} alt="Innovation & Creation" className="hero-img" />
