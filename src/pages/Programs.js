        ...
        levels: [
          ...
          },
          {
            ...
            modal: {
              ...
              sampleProject:
                "“Design Your Dream Room” – apply measurement, area, and scale.",
              description:
          ...
          },
          {
            ...
            modal: {
              ...
              sampleProject:
                "“Probability Game Lab” – create a board game using probability rules.",
              description:
          ...
          },
          {
            ...
            modal: {
              ...
              sampleProject:
                "“STEM Data Challenge” – analyze real-world data (sports, climate).",
              description:
        ...
        levels: [
          ...
          },
          {
            ...
            modal: {
              ...
              sampleProject:
                "“Mini Game” – design a simple interactive game with rules and scoring.",
              description:
          ...
          },
          {
            ...
            modal: {
              ...
              sampleProject:
                "“Capstone Project” – build a portfolio-ready project and present it.",
              description:
    ...
    <main className="programs-page">
      ...
      <section className="pg-hero">
        ...
        <h1 className="pg-title">
          ...
          <span className="brand-name brand-highlight"> LuminoStart™</span> or{" "}
          <span className="brand-name brand-highlight">LuminoCore™</span>
        </h1>

        <p className="pg-lead">
          Start with <strong>LuminoStart™</strong> (4 weeks) to map level + pacing, then move into{" "}
          <strong>LuminoCore™</strong> (12 weeks) for guided practice, projects, and certified progress.
      ...
      <section className="pg-section">
        <div className="courses-container three-column">
          ...
          <article className="course-card">
            ...
            {/* ✅ Replace Register with calendar booking */}
      ...
      {activeLevel && (
        <div className="modal-overlay" onClick={closeLevel} role="presentation">
          <div
            ...
            role="dialog"
            aria-modal="true"
            // ✅ prevents “overlap/off-screen” by forcing a max height + scrolling
            style={{
              maxHeight: "85vh",
              overflowY: "auto",
